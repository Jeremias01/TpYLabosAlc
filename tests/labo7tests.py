...
def run():
    ...
    A_rala_dict, dims = crear_rala(listado,32,89)
    ...
    A_rala_dict, dims = crear_rala(listado,50,50)
    ...
    A_rala_dict, dims = crear_rala(listado,10,10)
    ...
    A_rala = crear_rala(listado,3,3)
    v = np.random.random(3)
    v = v / np.linalg.norm(v)
    res = multiplicar_rala_vector(A_rala,v)
    ...
    A_rala = crear_rala(listado,5,5)
    v = np.random.random(5)
    print(multiplicar_rala_vector(A_rala,v), A @ v)
    assert np.allclose(multiplicar_rala_vector(A_rala,v), A @ v)
